...
@Slf4j
public abstract class NoAbstractRepositoryOrmImpl<T extends AbstractEntity> implements NoRepository<T> {
...
//        if(true){
//            throw new DataBaseErrorException("Database aspect exception");
//        }

        List<T> entities = findAllQuery().getResultList();
