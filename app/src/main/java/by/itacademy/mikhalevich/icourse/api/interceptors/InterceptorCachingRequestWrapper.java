 ...
 */
public class InterceptorCachingRequestWrapper extends HttpServletRequestWrapper {
	 ...
	 */
	public InterceptorCachingRequestWrapper(HttpServletRequest request) throws IOException {
		super(request);
	 ...
	 */
	public InterceptorCachingRequestWrapper(HttpServletRequest request, int contentCacheLimit) throws IOException {
		super(request);
